...
var x = [power, name];
return x;
} // end of calculcatePanel function
...
var feedback="";
feedback += "<p> Based on "+Math.round(dailyUseKw) +" kWh, you will need to purchase "+ panelsNeeded +" "+ panelName+" solar panels...</p>";
feedback += "<h2> Additional</h2>";
feedback += "<p> Your ave</p>";
feedback += "<p> Average Sunsh</p>";
feedback += "<p> Realistic watts</p>";
feedback += "<p> The NAME panel</p>"

document.getElementById('feedback').innerHTML=feedback;

} //end of calculateSolar function